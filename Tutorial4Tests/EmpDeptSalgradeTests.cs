...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        // How am I supposed to use SelectMany in this case?
        var result = emps
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps
            .SelectMany(emp => 
                    grades.Where(grade => emp.Sal >= grade.Losal && emp.Sal <= grade.Hisal), 
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps
            .GroupBy(emp => emp.DeptNo)
            .Select(group => new { DeptNo = group.Key, AvgSal = group.Average(emp => emp.Sal) }); 
